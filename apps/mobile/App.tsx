      ...
      <View style={styles.calorieCard}>
        ...
        <View style={styles.calorieStats}>
          ...
          <View style={[styles.calorieStat, styles.statBorder]}>
            <Text style={[styles.statValue, { color: "#22c55e" }]}>{remaining}</Text>
...
const styles = StyleSheet.create({
  ...
  screen: { flex: 1, padding: 16, backgroundColor: "#fafafa" },
  ...
  dateText: { fontSize: 13, color: "#737373", marginTop: 2 },
  ...
  calorieNumber: { fontSize: 36, fontWeight: "bold", color: "#22c55e" },
  calorieUnit: { fontSize: 12, color: "#737373" },
  ...
  statValue: { fontSize: 20, fontWeight: "bold", color: "#171717" },
  ...
  sectionTitle: { fontSize: 15, fontWeight: "600", color: "#171717", marginBottom: 12 },
  ...
  macroValue: { fontSize: 11, color: "#737373", marginTop: 4 },
  ...
  tabLabel: { fontSize: 10, color: "#a3a3a3", marginTop: 2 },
  ...
  closeBtn: { fontSize: 22, color: "#737373", padding: 4 },
  logTitle: { fontSize: 18, fontWeight: "bold", color: "#171717" },
  searchContainer: { marginBottom: 16 },
  searchInput: { backgroundColor: "#f5f5f5", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, color: "#171717" },
  ...
  quickLabel: { fontSize: 11, color: "#737373", marginTop: 4 },
  foodResult: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#fff", padding: 14, borderRadius: 12, marginBottom: 8 },
  foodInfo: { flex: 1 },
  foodName: { fontSize: 15, fontWeight: "500", color: "#171717" },
  foodBrand: { fontSize: 12, color: "#a3a3a3", marginTop: 2 },
  foodMacros: { alignItems: "flex-end" },
  foodCal: { fontSize: 14, fontWeight: "600", color: "#22c55e" },
  foodProtein: { fontSize: 11, color: "#3b82f6", marginTop: 2 },

  // Suggestions
  screenTitle: { fontSize: 24, fontWeight: "bold", color: "#171717", paddingTop: 8 },
  screenSub: { fontSize: 14, color: "#737373", marginTop: 4, marginBottom: 20 },
  ...
  remainingTitle: { fontSize: 13, fontWeight: "600", color: "#737373", marginBottom: 12 },
  remainingRow: { flexDirection: "row", justifyContent: "space-between" },
  remainingItem: { alignItems: "center" },
  remainingValue: { fontSize: 20, fontWeight: "bold", color: "#171717" },
  remainingLabel: { fontSize: 11, color: "#a3a3a3", marginTop: 2 },
  ...
  suggestionName: { fontSize: 16, fontWeight: "600", color: "#171717" },
  ...
  suggestionReason: { fontSize: 13, color: "#737373", marginBottom: 4 },
  suggestionCal: { fontSize: 12, color: "#a3a3a3" },
  ...
  weightCurrent: { fontSize: 36, fontWeight: "bold", color: "#171717" },
  ...
  weightDeltaText: { fontSize: 13, fontWeight: "600", color: "#22c55e" },
  ...
  adherenceDayLabel: { fontSize: 11, color: "#737373" },
  adherencePct: { fontSize: 9, color: "#a3a3a3", marginTop: 2 },
  streakRow: { flexDirection: "row", gap: 12 },
  streakItem: { flex: 1, backgroundColor: "#f0fdf4", borderRadius: 12, padding: 16, alignItems: "center" },
  streakNumber: { fontSize: 28, fontWeight: "bold", color: "#22c55e" },
  ...
  profileName: { fontSize: 22, fontWeight: "bold", color: "#171717" },
  profileGoal: { fontSize: 14, color: "#737373", marginTop: 4 },
  ...
  profileLabel: { fontSize: 14, color: "#737373" },
  profileValue: { fontSize: 14, fontWeight: "500", color: "#171717" },
});
